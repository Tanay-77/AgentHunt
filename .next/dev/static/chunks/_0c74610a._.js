...
function AuthCallbackPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthCallbackPage.useEffect": ()=>{
            ...
            const handleAuth = {
                "AuthCallbackPage.useEffect.handleAuth": async ()=>{
                    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
                    if (error) {
                        console.error('Auth check error in callback:', error);
                        router.push('/'); // Fallback
                    }
                }
            }["AuthCallbackPage.useEffect.handleAuth"];
            handleAuth();
            const { data: { subscription } } = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange({
                "AuthCallbackPage.useEffect": (event, session)=>{
            ...
            return ({
                "AuthCallbackPage.useEffect": ()=>subscription.unsubscribe()
            })["AuthCallbackPage.useEffect"];
        }
    }["AuthCallbackPage.useEffect"], [
        router
